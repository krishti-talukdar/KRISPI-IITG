...
const DRY_WORKBENCH_TEST_TUBE_POSITION = { xPercent: 0.35, yPercent: 0.28 };
const DRY_WORKBENCH_GLASS_ROD_POSITION = { xPercent: 0.35, yPercent: 0.22 };
const DRY_WORKBENCH_BUNSEN_POSITION = { xPercent: 0.35, yPercent: 0.75 };
