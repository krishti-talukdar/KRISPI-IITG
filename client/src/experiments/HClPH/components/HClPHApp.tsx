...
interface HClPHAppProps { onBack?: () => void }
...
export default function HClPHApp({ onBack }: HClPHAppProps) {
  ...
  useEffect(() => {
    ...
    if (isRunning && experimentStarted) interval = setInterval(() => setTimer((t) => t + 1), 1000);
  ...
  useEffect(() => {
    try {
      ...
      if (params.get('autostart') === '1') handleStart();
    } catch {}
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="min-h-[85vh] shadow-xl">
          <CardHeader className="bg-gradient-to-r from-emerald-50 via-lime-50 to-amber-50">
            <CardTitle className="text-2xl">HCl pH - Interactive Workbench</CardTitle>
          </CardHeader>
