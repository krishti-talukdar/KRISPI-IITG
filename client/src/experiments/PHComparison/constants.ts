...
export const GUIDED_STEPS = [
  ...
  { id: 4, title: 'Reset and Add CH₃COOH', description: 'Reset, then add acetic acid to the test tube.', action: 'Reset then add CH₃COOH', equipment: ['test-tube', 'acetic-0-01m'], completed: false },
