const PHComparisonData = {
  id: 8,
  title: "To determine and compare pH of 0.01 M HCl and 0.01 M CH₃COOH solution using universal indicator",
  description: "Use universal indicator to estimate and compare the pH of 0.01 M HCl (strong acid) and 0.01 M CH₃COOH (weak acid). Observe different indicator colors due to varying acid strengths.",
  ...
  stepDetails: [
    ...
    { id: 4, title: "Rinse/Reset and Add 0.01 M CH₃COOH", description: "Reset, then add acetic acid to the test tube.", duration: "3 minutes", completed: false },
