...
import AmmoniumBufferData from "../data";
import { useUpdateProgress } from "@/hooks/use-experiments";

interface Props { onBack?: () => void }

export default function AmmoniumBufferApp({ onBack }: Props) {
  ...
  const experiment = AmmoniumBufferData;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="min-h-[85vh] shadow-xl">
          <CardHeader className="bg-gradient-to-r from-emerald-50 via-lime-50 to-amber-50">
            <CardTitle className="text-2xl">Ammonium Buffer pH - Interactive Workbench</CardTitle>
          </CardHeader>
