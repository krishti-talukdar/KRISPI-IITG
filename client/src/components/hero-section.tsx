        ...
        <div className="flex min-h-[64vh] flex-col items-center justify-center py-10 text-center">
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-center">
            <Button
              ...
              className="rounded-md bg-emerald-500 px-9 py-5 text-sm font-medium text-white shadow-md shadow-emerald-500/20 hover:bg-emerald-600"
            >
            ...
            <SafetyGuideModal>
              <Button
                variant="outline"
                className="rounded-md border-2 border-slate-700 bg-white px-9 py-5 text-sm font-medium text-slate-900 hover:bg-slate-50"
              >
